...
(* OASIS_START *)
(* DO NOT EDIT (digest: 58991ceb17ef5875aa7d87bdeab43bb7) *)
(*
...
let setup_t =
  {
     ...
     test = [];
     doc = [("datalog", OCamlbuildDocPlugin.doc_build ".")];
     install = InternalInstallPlugin.install;
     uninstall = InternalInstallPlugin.uninstall;
     clean = [OCamlbuildPlugin.clean];
     clean_test = [];
     clean_doc = [("datalog", OCamlbuildDocPlugin.doc_clean ".")];
     distclean = [];
     distclean_test = [];
     distclean_doc = [];
     package =
     ...
     oasis_version = "0.3.0";
     oasis_digest =
       Some "n\203\173\131\144\176\231\175\155d\135\244W\005\2433";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
