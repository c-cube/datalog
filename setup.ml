...
(* OASIS_START *)
(* DO NOT EDIT (digest: 08ea7a35e85f8c6799df5e7600f91fbd) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/c-cube/datalog";
          synopsis = "An in-memory datalog implementation for OCaml";
          description =
            Some
              [
                 OASISText.Para
                   "An in-memory datalog implementation for OCaml. It focuses on big sets of rules with small relations, with frequent updates of the relations. Therefore, it tries to achieve good behavior in presence of incremental modifications of the relations."
              ];
          categories = [];
            ...
            [
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "Build and install the Unix interface";
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_pack = true;
                      lib_internal_modules = ["lib/Sequence"; "lib/Util"];
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Datalog_unix"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "datalog";
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "documentation for Datalog";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends = [InternalLibrary "datalog"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {exec_custom = false; exec_main_is = "datalog_cli.ml"});
               Executable
                 ({
                     cs_name = "topDownCli";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "topDownCli.ml"});
               SrcRepo
                 ({
                     cs_name = "head";
                     cs_data = PropList.Data.create ();
                   ...
                   {
                      src_repo_type = Git;
                      src_repo_location = "https://github.com/c-cube/datalog";
                      src_repo_browser =
                        Some
                          "https://github.com/c-cube/datalog/tree/master/src";
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "Y\227/\243\244\1643\149\197\030o\255\\\148y_";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
